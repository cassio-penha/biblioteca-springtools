...
public class PerfilController {
	...
	//		GET		http://localhost:8080/perfis
	//		GET		http://localhost:8080/perfis/80
	//		GET		http://localhost:8080/perfis/80/alexandre
	...
	public ResponseEntity<?> findByIdResumido(@PathVariable Integer id) {
...
//		}
		...
		if(perfilDto == null)
			return new ResponseEntity<>
				("{\"msg\" : \"Perfil não encontrado\"}", HttpStatus.NOT_FOUND);
		else
...
////		    pd.setDetail("Detalhes da exceção");
